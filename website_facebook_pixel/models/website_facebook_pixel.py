...
class WebsiteFacebookPixel(models.Model):    
    ...
    page_id = fields.Many2one('website.page', string ='Page', required=True)
    ...
    currency = fields.Many2one('res.currency', string='Concurrency', help="The currency for the value specified.")
